...
export default function Cesta() {
  ...
  try {
    const result = await createOrder(username, idCesta);

    // Si el servidor devuelve un pedido “vacío”, mostramos error al usuario
    if (!result || !result.orderId) {
      setError("No se pudo confirmar el pedido (cesta vacía o error en el servidor).");
      return;
    }
